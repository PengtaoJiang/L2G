...
def DeepLabV1_ResNet101_MSC(n_classes):
    return MSC(
        base=DeepLabV1_largeFOV(
            n_classes=n_classes, n_blocks=[3, 4, 23, 3]),
        scales=[0.5, 0.75],
    )
...
def DeepLabV2_VGG16_MSC(n_classes):
    return MSC(
        base=DeepLabV2_vgg16(
            n_classes=n_classes, atrous_rates=[6, 12, 18, 24]
        ),
        scales=[0.5, 0.75],
    )

def DeepLabV1_VGG16_MSC(n_classes):
    return MSC(
        base=DeepLabV1_vgg16(
            n_classes=n_classes, atrous_rates=[6, 12, 18, 24]
        ),
        scales=[0.5, 0.75],
    )
